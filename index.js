...
app.listen(port, () => {
  ...
  console.log(`     ┃ `.bold.brightGreen + ` /--/ Client /--/ `.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length - ` /--/ Client /--/ `.length) + "┃".bold.brightGreen)
  console.log(`     ┃ `.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length) + "┃".bold.brightGreen)
  console.log(`     ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`.bold.brightGreen)
});
...
const client = new Discord.Client({
  ...
  presence: {
    ...
    status : "online",
    activity: {
      name: `${config.prefix}help || Code by Limsathya`,
      type: 'LISTENING',
    },
  }
});
