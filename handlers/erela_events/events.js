var {
      ...
      client.manager
        .on("playerCreate", async (player) => {
            ...
            try {
              ...
              embed.addField(`Music Powered by Limsathya`, `**[Invite their Public Bot](https://discord.com/api/oauth2/authorize?client_id=861249452789596200&permissions=8&scope=bot)  •  [WEBSITE](https://xg-bot.netlify.app/)  •  [Get your OWN BOT](https://limsathya.netlify.app/)**`)
            } catch {}
  ...
  /**
   * @INFO
   * Bot Coded by <@594195050242768899> | https://github.com/Tomato6966/discord-js-lavalink-Music-Bot-erela-js
   * @INFO
